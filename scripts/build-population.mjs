...
const OUTPUT = resolve(ROOT, "src/data/population.owid.generated.ts");
...
function build() {
  ...
  const lines = [];
  lines.push(
    "// AUTO-GENERATED by scripts/build-population.mjs. DO NOT EDIT BY HAND.",
    "// Run `npm run build:population` to regenerate.",
    "//",
    "// Sources:",
    "//   - Our World in Data, 'Population' long-run dataset",
    "//     https://ourworldindata.org/grapher/population (CC BY 4.0)",
    "//     Combines HYDE v3.3, Gapminder v7, UN WPP 2024.",
    "//   - restcountries.com v3.1 for country centroids and area (MPL 2.0)",
    "",
    ...
    "  cca2: string;",
    "  /** Coarse continent / region from restcountries: Africa, Americas,",
    "   *  Asia, Europe, Oceania, Antarctic, Other. */",
    "  region: string;",
    "  /** Common-form English name. */",
    "  name: string;",
    "  /** Approximate centroid (degrees). */",
    "  lat: number;",
    "  lng: number;",
    "  /** Equal-area disc radius for dot scatter (degrees, 0.5-18). */",
    "  radius: number;",
    "  /** [year, population_in_millions] anchors, sorted ascending by year. */",
  ...
  for (const c of merged) {
    ...
    lines.push(
      "  {",
      `    code: "${c.code}",`,
      `    cca2: "${escapeStr(c.cca2)}",`,
      `    region: "${escapeStr(c.region)}",`,
  ...
  lines.push(
    ...
    "];",
    "",
    `export const OWID_BUILD_DATE = "${new Date().toISOString().slice(0, 10)}";`,
    "",
  );
